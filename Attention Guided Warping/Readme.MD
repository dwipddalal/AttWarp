...
### `main.py`
Runs the AttWarp pipeline end-to-end: loads the dataset, calls the LLaVA attention API, saves masks/attention outputs, and produces warped images.
...
- **`getmask(args)`**: runs LLaVA generation to return a 24×24 attention mask and model output.
